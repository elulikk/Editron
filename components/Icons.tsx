...
export const NewFileIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "h-6 w-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m.75 12l3 3m0 0l3-3m-3 3v-6m-1.125-4.5a3.375 3.375 0 00-3.375-3.375H8.25a3.375 3.375 0 00-3.375 3.375v11.25c0 1.864 1.511 3.375 3.375 3.375h5.25a3.375 3.375 0 003.375-3.375" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75h.008v.008H12v-.008zM12 15h.008v.008H12V15zm0-3h.008v.008H12v-.008zm-4.5-3.75h.008v.008H7.5v-.008zm0 3h.008v.008H7.5v-.008zm0 3h.008v.008H7.5v-.008zm3-6h.008v.008H10.5v-.008zm0 3h.008v.008H10.5v-.008zm0 3h.008v.008H10.5v-.008zM13.5 9h.008v.008H13.5V9zm0 3h.008v.008H13.5v-.008zm0 3h.008v.008H13.5v-.008z" />
    </svg>
);

export const CogIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "h-6 w-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.226l.56-1.682c.133-.401.52-.665.956-.665s.823.264.956.665l.56 1.682c.55.219 1.02.684 1.11 1.226l1.682.56c.401.133.665.52.665.956s-.264.823-.665.956l-1.682.56c-.09.542-.56 1.007-1.11 1.226l-.56 1.682c-.133.401-.52.665-.956.665s-.823-.264-.956-.665l-.56-1.682a2.25 2.25 0 01-1.11-1.226l-1.682-.56a1.125 1.125 0 01-.665-.956c0-.436.264-.823.665-.956l1.682-.56z" />
...
export const TerminalIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "h-6 w-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 7.5l3 2.25-3 2.25m3 0h3.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);